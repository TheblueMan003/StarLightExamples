...
if (Compiler.isJava){
    private macro void _set(mcposition position, mcobject block){
        /setblock $(position) $(block)
    }
    private macro void _fill(mcposition start, mcposition end, mcobject block){
        /fill $(start) $(end) $(block)
    }
    private macro void _replace(mcposition start, mcposition end, mcobject block, mcobject fro){
        /fill $(start) $(end) $(block) replace $(fro)
    }
    private macro void _fill(mcposition start, mcposition end, mcobject block, string mod){
        /fill $(start) $(end) $(block) $(mod)
    }
    private macro void _clone(mcposition start, mcposition end, mcposition target, string mod1, string mod2){
